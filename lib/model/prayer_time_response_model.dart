...
PrayerTimeResponseModel prayerTimeResponseModelFromJson(String str) =>
    PrayerTimeResponseModel.fromJson(json.decode(str));

String prayerTimeResponseModelToJson(PrayerTimeResponseModel data) =>
...
abstract class PrayerTimeResponseModel with _$PrayerTimeResponseModel {
  ...
  factory PrayerTimeResponseModel.fromJson(Map<String, dynamic> json) =>
      _$PrayerTimeResponseModelFromJson(json);
}

@freezed
abstract class Data with _$Data {
  const factory Data({
    @JsonKey(name: "timings") final Timings? timings,
...
abstract class Date with _$Date {
  const factory Date({
    ...
    @JsonKey(name: "hijri") final Hijri? hijri,
    @JsonKey(name: "gregorian") final Gregorian? gregorian,
  }) = _Date;
...
abstract class Gregorian with _$Gregorian {
  const factory Gregorian({
    ...
    @JsonKey(name: "weekday") final GregorianWeekday? weekday,
    @JsonKey(name: "month") final GregorianMonth? month,
    @JsonKey(name: "year") final String? year,
    @JsonKey(name: "designation") final Designation? designation,
    @JsonKey(name: "lunarSighting") final bool? lunarSighting,
  }) = _Gregorian;
...
abstract class Designation with _$Designation {
  const factory Designation({
    ...
    @JsonKey(name: "expanded") final String? expanded,
  }) = _Designation;
...
abstract class GregorianWeekday with _$GregorianWeekday {
  const factory GregorianWeekday({@JsonKey(name: "en") final String? en}) =
      _GregorianWeekday;
...
abstract class Hijri with _$Hijri {
  const factory Hijri({
    ...
    @JsonKey(name: "format") final String? format,
    @JsonKey(name: "day") final String? day,
    @JsonKey(name: "weekday") final HijriWeekday? weekday,
    @JsonKey(name: "month") final HijriMonth? month,
    @JsonKey(name: "year") final String? year,
    @JsonKey(name: "designation") final Designation? designation,
    @JsonKey(name: "holidays") final List<dynamic>? holidays,
    @JsonKey(name: "adjustedHolidays") final List<dynamic>? adjustedHolidays,
...
abstract class Meta with _$Meta {
  const factory Meta({
    ...
    @JsonKey(name: "method") final Method? method,
    @JsonKey(name: "latitudeAdjustmentMethod")
    final String? latitudeAdjustmentMethod,
    @JsonKey(name: "midnightMode") final String? midnightMode,
    @JsonKey(name: "school") final String? school,
    @JsonKey(name: "offset") final Map<String, int>? offset,
  }) = _Meta;
...
abstract class Timings with _$Timings {
  const factory Timings({
    ...
    @JsonKey(
      name: "Sunrise",
      fromJson: convertTo12Hour,
      toJson: convertTo24Hour,
    )
    final TimeOfDay? sunrise,
    @JsonKey(name: "Zuhr", fromJson: convertTo12Hour, toJson: convertTo24Hour)
    final TimeOfDay? Zuhr,
